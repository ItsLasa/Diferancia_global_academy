...
const Home: React.FC = () => {
  ...
  // Certificate Courses Data
  const certificateCourses = [
    { title: "Certificate in Housekeeping Operations", image: C1, description: "Professional housekeeping training for clean, safe, and efficient environments." },
    { title: "Basic Certificate in Professional Cookery", image: C2, description: "Learn cooking techniques with professional cleaning and maintenance for safe, efficient spaces." },
    { title: "Certificate in Food & Beverage", image: C3, description: "Gain practical knowledge in restaurant service, customer handling, table setup, and beverage management." },
    { title: "Certificate in Front Office Management", image: C4, description: "Learn reception operations, guest service management, reservations handling, and communication skills." },
    { title: "Certificate in Pastry & Bakery", image: C5, description: "Master baking techniques, pastry production, cake decoration, and dessert presentation." },
    { title: "Certificate in Hotel & Tourism Management", image: C6, description: "Build leadership, hospitality operations, and customer service skills for a successful hotel career." },
  ...
  const feedbackData = [
    { name: "Nimal Perera", course: "Front Office Management", rating: 5, review: "The training was practical and industry-focused. I gained real confidence working in hospitality after completing this program.", image: Profile },
    { name: "Sanduni Fernando", course: "Pastry & Bakery", rating: 5, review: "Excellent lecturers and hands-on sessions. The bakery course helped me start my own small business.", image: Profile },
    { name: "Kamal Silva", course: "Housekeeping Operations", rating: 4, review: "The program gave me the skills needed for real-world housekeeping roles. Very informative and structured.", image: Profile },
    { name: "Chathuri Jayasinghe", course: "Food & Beverage Service", rating: 5, review: "I loved the practical training and real restaurant simulations. It made me confident to work in a busy hotel environment.", image: Profile },
    { name: "Ruwan Weerasinghe", course: "Culinary Arts", rating: 5, review: "The culinary techniques I learned were top-notch. The instructors were very supportive and knowledgeable.", image: Profile },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        >
          <div className="lg:w-2/3">
            ...
            <p className="text-2xl text-gray-800 leading-relaxed text-justify md:text-left">
              Diferancia Global Academy (Pvt) Ltd is a professional education and training institute committed to delivering quality, industry-focused courses that empower students with practical skills and knowledge for career success.
            </p>
          </div>
          <div className="lg:w-1/3 flex justify-center">
            <img src={Logo3} alt="Logo" className="w-60 object-contain" />
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-8 mb-16 py-10">
          <div className="md:w-1/3 flex items-center">
            <p className="text-gray-800 font-medium text-2xl leading-snug text-center md:text-left">
              Organization dedicated to addressing today's challenges and emerging opportunities, bringing everything together under one unified vision.
            </p>
          </div>
          <div className="flex flex-1 items-center justify-around md:border-l-2 border-black py-2">
            <div className="flex-1 text-center">
        ...
        <section className="py-10">
          <div className="flex items-center justify-center gap-6 mb-12">
            <div className="h-[1.5px] bg-black flex-1 max-w-[250px]"></div>
            <h2 className="text-4xl md:text-5xl font-bold text-[#1a233a] whitespace-nowrap">
              Our Courses
            </h2>
            <div className="h-[1.5px] bg-black flex-1 max-w-[250px]"></div>
