...
const CertificateCourse: React.FC = () => {
  ...
  const hotelCourses: Course[] = [
...

    {
      ...
      detailImage: C2,
      description:
        "Learn cooking techniques with professional kitchen training.",
      duration: "10 Days (08 Hours per Day)",
      certification: "Basic Certificate in Professional Cookery",
      jobOpportunities: [
        "Commis Chef",
...

    {
      ...
      detailImage: C3,
      description:
        "Gain practical knowledge in restaurant service and beverage management.",
      duration: "6 Days (Intensive Practical Training)",
    },

    {
      ...
      image: C4,
      description:
        "Learn reception operations, guest service management, and reservations handling.",
    },

    {
      ...
      image: C5,
      description:
        "Master baking techniques, pastry production, and dessert presentation.",
    },

    {
      ...
      detailImage: C6,
      description:
        "Build leadership, hospitality operations, and customer service skills.",
      duration: "Foundation Program",
      certification:
        "Recognized Certificate in Hotel, Tourism & Hospitality Management",
    },
  ...
  const educationCourses: Course[] = [
    {
      title: "Certificate in English",
      image: E1,
      detailImage: E1,
      description: "Improve speaking, writing, reading, and listening skills.",
      benefits: [
        "Improve English speaking confidence",
...

    {
      ...
      image: E2,
      detailImage: E2,
      description: "Learn computer fundamentals, MS Office, internet usage.",
      benefits: [
        "Improve computer skills",
        "Learn Microsoft Office",
        "Gain hands-on computer experience",
      ],
    },
    ...
    <div className="font-serif">
      ...
      <section className="bg-gray-200 py-12 sm:py-16 px-4 sm:px-6">
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          <div className="h-[1px] bg-black flex-1 max-w-[300px]" />
          <h2 className="text-3xl md:text-4xl font-bold text-[#1a233a] text-center">
            Our Courses
          </h2>
          <div className="h-[1px] bg-black flex-1 max-w-[300px]" />
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <h3 className="text-lg font-bold border-b border-black w-fit mb-8">
            Hotel and Tourism Management
          </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {hotelCourses.map((course, index) => (
              ...
              >
                ...
                <h4 className="mt-4 font-bold text-[#1a233a]">
                  {course.title}
                </h4>
                ...
                <button className="mt-4 bg-[#C17900] hover:bg-[#a56700] text-white px-6 py-2 rounded-md text-sm font-semibold w-full sm:w-auto">
                  View More
                </button>
              </div>
            ))}
