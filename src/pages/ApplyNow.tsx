...
const ApplyNow: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // You can handle form data including selectedCourse here
    setIsModalOpen(true);
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col space-y-2">
                ...
                <input id="nic" required type="text" placeholder="12345678900"
                  className="bg-white rounded-xl py-3 px-4 outline-none focus:ring-2 focus:ring-orange-500 transition-all" />
              </div>
              <div className="flex flex-col space-y-2">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <input id="address" required type="text" placeholder="123, Main Street, Colombo"
                className="bg-white rounded-xl py-3 px-4 outline-none focus:ring-2 focus:ring-orange-500 transition-all" />
            </div>
            ...
            <div className="flex flex-col space-y-2">
              ...
              <textarea id="notes" rows={4} placeholder="Any additional information..."
            ...
            <div className="pt-4 flex justify-center">
              <button type="submit"
                className="bg-[#e68a00] hover:bg-[#ff9900] text-white text-xl font-bold py-3 px-16 rounded-xl transition-all shadow-lg active:scale-95 w-full md:w-auto">
                Submit
              </button>
            </div>
